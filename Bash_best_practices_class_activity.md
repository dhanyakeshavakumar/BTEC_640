...
>Applications			Movies
>barcode02.bam			Music
>barcode02.sam			out.fa
>btec_640			Pictures
>BullseyeCoverageError.txt	RABV STATEWISE.qgz
>Desktop				Sites
>Documents			SS.qgz
>Downloads			SSPE Hospital data.qgz
>Library				Zotero
>
>#-------------------------
>#Command 3:
...
>#Output
>total 120
>drwx------@  4 dhany  staff    128 11 Jan  2026 Applications
>-rw-r--r--   1 dhany  staff      0 22 May  2025 barcode02.bam
>-rw-r--r--   1 dhany  staff      0 22 May  2025 barcode02.sam
>drwxr-xr-x   2 dhany  staff     64  9 Sep 17:58 btec_640
>-rwxr-xr-x   1 dhany  staff    331  3 May  2025 >BullseyeCoverageError.txt
>drwx------@ 44 dhany  staff   1408  9 Sep 18:00 Desktop
>drwx------+  9 dhany  staff    288  9 Sep 17:34 Documents
>drwx------@ 32 dhany  staff   1024  9 Sep 18:01 Downloads
>drwx------@ 76 dhany  staff   2432 11 Jan  2026 Library
>drwx------+  5 dhany  staff    160  7 Oct  2025 Movies
>drwx------+  4 dhany  staff    128 25 Aug  2025 Music
>-rw-r--r--   1 dhany  staff      0 22 May  2025 out.fa
>drwx------+  8 dhany  staff    256  2 Jun  2025 Pictures
>-rwxr-xr-x   1 dhany  staff  22904  3 May  2025 RABV STATEWISE.qgz
>drwxr-xr-x+  3 dhany  staff     96  3 May  2025 Sites
>-rwxr-xr-x   1 dhany  staff  16220  3 May  2025 SS.qgz
>-rwxr-xr-x   1 dhany  staff  16253  3 May  2025 SSPE Hospital data.qgz
>drwxr-xr-x  10 dhany  staff    320 11 Dec  2025 Zotero
>
>```
>
...
><br>class_excercises	genomics_project	transcriptomics_project

><br>drwxr-xr-x  2 dhany  staff  64 14 Sep 13:38 class_excercises
><br>drwxr-xr-x  2 dhany  staff  64 14 Sep 13:38 genomics_project
><br>drwxr-xr-x  2 dhany  staff  64 14 Sep 13:39 transcriptomics_project
...
><br> -p flag enables creation of two consequent folders (folder and a subfolder),
><br>without -p flag, it displayed error 
><br>
...
```
bash-3.2$ cd btec_640/
bash-3.2$ ls
class_excercises
bash-3.2$ mkdir genomics_project
bash-3.2$ mkdir transcriptomics_project
bash-3.2$ mkdir -p genomics_project/input_data genomics_project/final_output genomics_project/analysis genomics_project/src
bash-3.2$ ls genomics_project/
analysis	final_output	input_data	src
bash-3.2$ pwd
/Users/dhany/desktop/btec_640
bash-3.2$ mkdir -p transcriptomics_project/input_data transcriptomics_project/final_output transcriptomics_project/analysis transcriptomics_project/src
bash-3.2$ ls
class_excercises	genomics_project	transcriptomics_project
bash-3.2$ ls transcriptomics_project/
analysis	final_output	input_data	src
```
